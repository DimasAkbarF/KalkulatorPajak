      ...
      <div className="mx-auto max-w-6xl text-center">
        ...
        <div className="mx-auto mt-9 grid max-w-4xl gap-4 sm:grid-cols-3">
          {stats.map((item) => (
            <div
              key={item.label}
              className="rounded-3xl border border-slate-200 bg-white/85 p-5 text-left shadow-sm backdrop-blur transition-colors duration-500 dark:border-white/10 dark:bg-white/[0.04] dark:shadow-none"
            >
        ...
        <div className="mt-9 flex flex-col items-center gap-3">
          <button
            type="button"
            onClick={onStart}
            className="inline-flex items-center justify-center rounded-xl bg-blue-800 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:bg-blue-900 focus:outline-none focus:ring-4 focus:ring-blue-100 dark:bg-white dark:text-slate-950 dark:hover:bg-slate-200 dark:focus:ring-white/20"
          >
            Mulai Hitung Pajak
          </button>
